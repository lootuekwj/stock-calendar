        ...
        <main className="space-y-4 px-4 pb-8 pt-4">
          ...
          {loading ? (
            ...
            <>
              ...
              <TrendChart snapshots={snapshots} selectedBrokers={selectedBrokers} currentMonth={currentMonth} calcMode={calcMode} />
            </>
          )}
        </main>
